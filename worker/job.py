        ...
        if req_type in ["img2img", "txt2img"]:
            ...
            if self.current_model == "Stable Diffusion 2 Depth":
                ...
                generator = Depth2Img(
                    ...
                    load_concepts=gen_payload["use_embeds"],
                    concepts_dir="models/custom/sd-concepts-library",
                    model_baseline=self.model_manager.available_models[self.current_model]["baseline"],
                    embeds = self.model_manager.available_embeds,
